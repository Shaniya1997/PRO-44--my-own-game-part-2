...
var ball = createSprite(384,355,10,10);
 ball.shapeColor = "blue";
 var trophy = createSprite(28,110,30,30);
trophy.addImage(trophyImg);
trophy.scale = 10;

var block1 = createSprite(335,350,200,5);
var block2 = createSprite(172,351,80,5);
var block3 = createSprite(65,351,80,5);
var block4 = createSprite(170,255,345,5);
var block5 = createSprite(342,203,5,50);
var block6 = createSprite(342,86,5,123);
var block7 = createSprite(170,135,340,5);
var block8 = createSprite(265,78,5,110);
var invisible = createSprite(265,10,5,30);
invisible.visible = false;
var block9 = createSprite(70,55,5,110);
var invisible2 = createSprite(70,121,5,30);
invisible2.visible = false;

//Respawn point
var spawn = createSprite(2.6,276,5,27);
spawn.shapeColor = "pink";
var spawn2 = createSprite(13,288,25,5);
spawn2.shapeColor = "pink";
var spawn3 = createSprite(12,263,25,5);
spawn3.shapeColor = "pink";


//obstacles
var barrier1 = createSprite(345,390,3,25);
var barrier2 = createSprite(320,362,3,28);
var barrier3 = createSprite(295,390,3,25);


//moving obstacles
var slime = createSprite(30,377,40,40);
slime.shapeColor = "red";
slime.velocityX = 5;
var enemy = createSprite(200,300,10,13);
enemy.velocityY = 4;
enemy.shapeColor = "red";
var enemy2 = createSprite(139,300,10,13);
enemy2.velocityY = 3;
enemy2.shapeColor = "red";
var enemy3 = createSprite(270,300,10,13);
enemy3.velocityY = 5;
enemy3.shapeColor = "red";
var enemy4 = createSprite(331,300,10,13);
enemy4.velocityY = 6;
enemy4.shapeColor = "red";
var slime2 = createSprite(372,152,50,20);
slime2.velocityY = 5;
slime2.shapeColor = "red";
var enemy5 = createSprite(88,14,10,10);
enemy5.velocityY = 2;
enemy5.velocityX = -2;
enemy5.shapeColor = "red";
var enemy6 = createSprite(243,14,10,10);
enemy6.velocityY = 3;
enemy6.velocityX = -3;
enemy6.shapeColor = "red";
var enemy7 = createSprite(164,54,10,10);
enemy7.velocityY = -6;
enemy7.velocityX = -5;
enemy7.shapeColor = "red";
var enemy8 = createSprite(244,20,10,10);
enemy8.velocityY = -5;
enemy8.velocityX = 6;
enemy8.shapeColor = "red";


var safe = createSprite(210,342,5,22);
safe.shapeColor = "green";
var safe2 = createSprite(220,330,24.5,5);
safe2.shapeColor = "green";
var safe3 = createSprite(235,340,5,25);
safe3.shapeColor = "green";
var safe4 = createSprite(130,342,5,22);
safe4.shapeColor = "green";
var safe5 = createSprite(119,330,24,5);
safe5.shapeColor = "green";
var safe6 = createSprite(108,342,5,22);
safe6.shapeColor = "green";
var safe7 = createSprite(357,255,25,5);
safe7.shapeColor = "green";
var safe8 = createSprite(342,243,5,29);
safe8.shapeColor = "green";
var safe9 = createSprite(356,231,25,5);
safe9.shapeColor = "green";
var safe10 = createSprite(328,177,33,5);
safe10.shapeColor = "green";
var safe11 = createSprite(313,164,5,30);
safe11.shapeColor = "green";
var safe12 = createSprite(327,148,33,5);
safe12.shapeColor = "green";

var point = createSprite(352,85,5,5);
point.scale = 0.2;
point.addImage(pointImg);
var point2 = createSprite(370,85,5,5);
...
function draw() {
      ...
      if(ball.isTouching(trophy)){
       gameState = "end";
      playSound("sound://category_whoosh/alien_ship_flyby_whoosh_13_light.mp3"); 
      }
  ...
  text("FINISH",9,64);
      ...
      slime.bounceOff(leftEdge);
      slime.bounceOff(barrier3);
      slime2.bounceOff(safe9);
      slime2.bounceOff(topEdge);
